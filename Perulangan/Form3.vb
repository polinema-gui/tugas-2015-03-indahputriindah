Public Class Form3
    ...
    Private Sub hitungButton_Click(sender As Object, e As EventArgs) Handles hitungButton.Click
        Dim list As List(Of List(Of Integer)) = Me.parseMatrix(Me.Matrik1Text.Text)
        Dim daftar As List(Of List(Of Integer)) = Me.parseMatrix(Me.Matrik2Text.Text)
        If ((Not list Is Nothing) And (Not daftar Is Nothing)) Then
            If Me.isValidMatrix(list, daftar) Then
                Select Case Convert.ToString(Me.ComboOperasi.SelectedItem)
                    Case "Tambah"
    ...
    Private Sub hasilText_TextChanged(sender As Object, e As EventArgs) Handles hasilText.TextChanged

    End Sub


   
    Private Sub ComboOperasi_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboOperasi.SelectedIndexChanged
