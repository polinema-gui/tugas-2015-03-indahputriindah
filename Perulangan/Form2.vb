Public Class Form2
    ...
    Private Function pyramid(input As Integer) As String
        ...
        Return bintang
    End Function
    Private Function invertedPyramid(input As Integer) As String
...
Label_005D:
        ...
        Return bintang
    End Function
    Private Function invertedHollowPyramid(input As Integer) As String
        Dim angka2 As Integer
        Dim bintang As String = String.Empty
        Dim angka As Integer = input
Label_0089:
        ...
        Return bintang
    End Function
    Private Function hollowPyramid(input As Integer) As String
        Dim bintang As String = String.Empty
        Dim angka1 As Integer = input
        Dim i As Integer = 1
        Do While (i <= angka1)
